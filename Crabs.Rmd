...
holddf <- subset(all, Species.y == "Irroratus")
ggplot(holddf, aes(x = WW, y = proportion.eaten, fill=as.factor(Period))) + geom_point() + facet_wrap(~Trial.y,scales = "free_x") + ggtitle("Cancer")
holddf <- subset(all, Species.y == "Carcinus")
ggplot(holddf, aes(x = WW, y = proportion.eaten, fill=as.factor(Period))) + geom_point() + facet_wrap(~Trial.y,scales = "free_x") + ggtitle("Carcinus")
holddf <- subset(all, Species.y == "Hemigrapsus")
ggplot(holddf, aes(x = WW, y = proportion.eaten, fill=as.factor(Period))) + geom_point() + facet_wrap(~Trial.y,scales = "free_x") + ggtitle("Hemigrapsus")
```